...
if __name__ == "__main__":
    ...
    scheme_configs = [
        ...
        SchemeConfig(
            label="8-SSB reference: 6x4H coarse beam centered at SSB qh_c",
            family="array_based",
        ...
        # SchemeConfig(
        #     label="Ideal reference: 6x8H fine beam exactly centered at SSB qh_c",
        #     family="array_based",
        ...
        # -----------------------------------------------------------------
        # PRG-/bundle-based schemes for comparison with RE-level comb-DMRS
        # -----------------------------------------------------------------
        # # Control: same centered fine beam, but CE is performed per 12RB bundle.
        # # This helps distinguish PRG/bundle CE effects from beam/precoding gains.
        # SchemeConfig(
        #     label="PRG control: centered fine beam, legacy DMRS, 12RB CE",
        #     family="array_based",
        #     scheme="array_centered_fine",
        #     prg_size_rb=12,
        #     prg_precoding_mode="traditional",
        ...
        # Array/FDM fine-beam refinement: first 24RB use fine beam A, last 24RB use fine beam B.
        # Uses legacy single-state DMRS pattern and bundle-wise fullband CE.
        SchemeConfig(
            label="PRG/FDM: array 16-dir fine pair, 24RB+24RB, legacy DMRS",
            family="array_based",
        ...
        # Precoding-based PRG cyclic scheme: same centered spatial beam, PRG-level dual-pol phase cycling.
        # With 48RB and PRG=12RB, the four PRGs use [1,1], [1,j], [1,-1], [1,-j].
        SchemeConfig(
            label="PRG: precoding cyclic dual-pol, centered spatial beam, PRG=24RB",
        ...
        # # Precoding-based PRG cyclic scheme with two spatial bases, using the two associated fine beams.
        # # This is closer to spatial beam-domain precoding than pure dual-pol phase cycling.
        # SchemeConfig(
        #     label="PRG: precoding cyclic adjacent spatial basis, PRG=12RB",
        #     family="precoding_based",
        #     scheme="precoding_cyclic",
        #     prg_size_rb=12,
        #     prg_precoding_mode="cyclic",
        ...
        # 16 fine directions: two adjacent fine beams around the selected SSB center.
        SchemeConfig(
    ...
    out_csv = "sib1_2v4h_2v8h_comb_re_dmrs_with_prg_bler.csv"
    out_png = "sib1_2v4h_2v8h_comb_re_dmrs_with_prg_bler.png"

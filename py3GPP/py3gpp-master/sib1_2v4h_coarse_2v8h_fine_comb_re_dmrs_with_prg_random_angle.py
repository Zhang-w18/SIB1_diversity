...
if __name__ == "__main__":
    ...
    scheme_configs = [
        # ================================================================
        # Baselines: coarse SSB beam with different CE bundle sizes
        # ================================================================
        SchemeConfig(
        ...
        # ================================================================
        # PRG-based array fine-beam schemes
        #   - Wbf state alternates between qh_a and qh_b per PRG
        #   - legacy DMRS
        #   - CE bundle size follows prg_size_rb
        # ================================================================
        SchemeConfig(
        ...
        # ================================================================
        # PRG-based dual-pol precoding schemes
        #   - same centered spatial beam qh_center
        #   - PRG-level dual-pol states [1,1] / [1,j]
        #   - use two-state phase_table=(0, pi/2) in simulate_bler_compare()
        # ================================================================
        SchemeConfig(
    ...
    out_csv = "sib1_2v4h_2v8h_comb_re_dmrs_with_prg_random_angle_bler.csv"
    out_png = "sib1_2v4h_2v8h_comb_re_dmrs_with_prg_random_angle_bler.png"

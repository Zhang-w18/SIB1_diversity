...
if __name__ == "__main__":
    ...
    scheme_configs = [
        ...
        # SchemeConfig(
        #     label="Array-based: refined 8-ant fine beam, full 96RB",
        #     family="array_based",
        ...
        SchemeConfig(
            label="Precoding-based: cyclic dual-pol, PRG=24RB",
    ...
    out_csv = "sib1_array_vs_precoding_fine_beam_bler_v3.csv"
    out_png = "sib1_array_vs_precoding_fine_beam_bler_v3.png"

...
每次正式方案仿真使用同编号的 `plan-XXX.md` 和 `result-XXX.md`。实验开始前创建plan，运行结束后创建result。

当前下一个可用编号：`006`

| 编号 | 实验标题 | Plan | Result | 状态 |
|---:|---|---|---|---|
| 001 | 7 GHz、48 PRB四方案初步BLER | [plan-001.md](./plan-001.md) | — | 计划中 |
...
只增加相同配置的trial时继续使用原编号，并在原result中记录新增trial范围。改变系统配置、方案、CDD循环移位、接收机或统计口径时使用新编号。
